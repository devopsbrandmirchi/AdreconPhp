...
<div class="pagehead" style="margin-bottom:22px">
  <div>
    ...
    <div class="sub">
      ...
      <?= (int)$totalAccounts ?> account<?= $totalAccounts === 1 ? '' : 's' ?> ·
      each has its own search plan
...
<?php if (!$groups): ?>
  <div class="card pad">
    <p style="margin:0;color:var(--ink-2)">
      No agencies yet. <a href="admin.php">Add an agency</a> and attach clients under Client access.
    </p>
  </div>
<?php else: ?>
<div class="card">
  ...
  <div class="agency-row" onclick="window.location='<?= h($openHref) ?>'" role="link" tabindex="0"
    ...
    <div style="flex:1;min-width:0">
      ...
      <div class="agency-sub">
        <?= (int)$ag['accounts'] ?> account<?= $ag['accounts'] === 1 ? '' : 's' ?> ·
...
<div class="callout" style="margin-top:20px">
  <b>New hierarchy:</b> Agency → accounts (clients) → clusters → terms → locations.
  The search plan lives at the <b>agency</b> level. A “Solo owner” is just an agency with one account.
